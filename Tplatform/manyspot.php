...
<?
    ...
    <TT>
        ...
        if(!$select_db){
            ...
            $sql_query="select * from smallspot where region= '".$region."' ";
            ...
            while($row=mysql_fetch_array($result)){
                ...
                echo '<td width=20%><center><img src=../Tplatform/pic/spot/'.$row[0].'.jpg width=150 height=150><br>';
                echo '<a href=spot.php?sid='.$row[0].'&bid='.$bid.'>'.$row[1].'</a>';
                $cnt++;
