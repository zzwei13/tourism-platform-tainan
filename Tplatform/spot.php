...
<?
    ...
    <TT>
        ...
        if(!$select_db){
            ...
            $sql_query="select * from smallspot where sid= '".$sid."' ";
            ...
            while($row=mysql_fetch_array($result)){
                ...
                //if($cnt==6)
                echo '<tr>';
               	echo '<br><br><td width=20%><center><img src=../Tplatform/pic/spot/'.$row[0].'.jpg width=50% height=50%><br>';
                
			   //echo '<p>usrid:'.$usrid.'<br>';
			   	echo '<br>';
				//echo str_pad("店名",8).$row[1].'<br></span>';

				echo '<span style="font-size: 20px;"> 景點名稱:'.$row[1].'<br></span>';
