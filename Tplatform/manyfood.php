...
#menu ul li>ul{
 ...
 <script type="text/javascript">
	...
	dots[now].style.backgroundColor="darkblue";
	}
...
<?
    ...
    <TT>
        ...
        if(!$select_db){
            ...
            $sql_query="select * from smallfood where region= '".$region."' ";
            ...
            while($row=mysql_fetch_array($result)){
                ...
                echo '<td width=20%><center><img src=../Tplatform/pic/food01/'.$row[0].'.jpg width=150 height=150><br>';
                echo '<a href=food.php?sid='.$row[0].'&bid='.$bid.'>'.$row[1].'</a>';
                $cnt++;
            }
            echo '</table>';
        }
